...
public class EslHeaders
{
     ...
     * <p>
     * Note this enm will need to be kept in synch with any new headers introduced on the server side.
     * 
     * @author david varnes 
     */
    public enum Name
     ...
     * <p>
     * This values are not coded as an enm to allow for the very large range of possible values,
